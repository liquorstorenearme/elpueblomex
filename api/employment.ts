...
export default async function handler(req: Request): Promise<Response> {
  ...
  const toEmail = process.env.EP_CAREERS_TO || process.env.EP_TO_EMAIL || "hello@elpueblomex.com";
  ...
  if ((await rateLimit("form:employment", ip, RL_MAX, RL_WINDOW_S)).limited) return fallbackBack("rate");
